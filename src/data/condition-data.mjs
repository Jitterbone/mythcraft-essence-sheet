/**
 * mythcraft-essence-sheet | src/data/condition-data.mjs
 *
 * Canonical MythCraft condition definitions and active effect configurations.
 */
...
export const mcConditions = [
  {
    id: 'absorb',
    label: 'Absorb',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/absorb.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/absorb.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "absorb": true }, "mythcraft-hud": { "absorb": true } }
  },
  {
    id: 'affinity',
    label: 'Affinity',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/affinity.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/affinity.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "affinity": true }, "mythcraft-hud": { "affinity": true } }
  },
  {
    id: 'bleeding',
    label: 'Bleeding',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/bleeding.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/bleeding.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "bleeding": true }, "mythcraft-hud": { "bleeding": true } }
  },
  {
    id: 'blinded',
    label: 'Blinded',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/blinded.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/blinded.svg',
    description: 'You cannot see or gain any benefits from any ability requiring sight. All creatures are Unseen.',
    changes: [],
    flags: { "mythcraft-essence-sheet": { "blinded": true }, "mythcraft-hud": { "blinded": true } }
  },
  {
    id: 'bloodied',
    label: 'Bloodied',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/bloodied.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/bloodied.svg',
    description: 'You gain the Bloodied condition when you have equal to or less than 1⁄2 your max HP.',
    changes: [],
    flags: { "mythcraft-essence-sheet": { "bloodied": true }, "mythcraft-hud": { "bloodied": true } }
  },
  {
    id: 'broken',
    label: 'Broken',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/broken.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/broken.svg',
    description: 'You are Frightened and Shaken. You must use all available movement to retreat from perceived danger.',
    changes: [],
    flags: { "mythcraft-essence-sheet": { "broken": true }, "mythcraft-hud": { "broken": true } }
  },
  {
    id: 'burning',
    label: 'Burning',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/burning.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/burning.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "burning": true }, "mythcraft-hud": { "burning": true } }
  },
  {
    id: 'charmed',
    label: 'Charmed',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/charmed.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/charmed.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "charmed": true }, "mythcraft-hud": { "charmed": true } }
  },
  {
    id: 'chilled',
    label: 'Chilled',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/chilled.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/chilled.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "chilled": true }, "mythcraft-hud": { "chilled": true } }
  },
  {
    id: 'concealed',
    label: 'Concealed',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/concealed.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/concealed.svg',
    ...
    flags: { "mythcraft-essence-sheet": { "concealed": true }, "mythcraft-hud": { "concealed": true } }
  },
  {
    id: 'partialCover',
    label: 'Partial Cover',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/cover.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/cover.svg',
    ...
    flags: { "mythcraft-essence-sheet": { "partialCover": true, "cover": true }, "mythcraft-hud": { "partialCover": true, "cover": true } }
  },
  {
    id: 'totalCover',
    label: 'Total Cover',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "totalCover": true, "cover": true }, "mythcraft-hud": { "totalCover": true, "cover": true } }
  },
  {
    id: 'cover',
    label: 'Cover',
    ...
    flags: { "mythcraft-essence-sheet": { "cover": true, "partialCover": true }, "mythcraft-hud": { "cover": true, "partialCover": true } }
  },
  {
    id: 'dazed',
    label: 'Dazed',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/dazed.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/dazed.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "dazed": true }, "mythcraft-hud": { "dazed": true } }
  },
  {
    id: 'deafened',
    label: 'Deafened',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/deafened.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/deafened.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "deafened": true }, "mythcraft-hud": { "deafened": true } }
  },
  {
    id: 'demoralized',
    label: 'Demoralized',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/demoralized.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/demoralized.svg',
    description: 'All attacks against a Demoralized creature gain +1 TA.',
    changes: [],
    flags: { "mythcraft-essence-sheet": { "demoralized": true }, "mythcraft-hud": { "demoralized": true } }
  },
  {
    id: 'engaged',
    label: 'Engaged',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/engaged.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/engaged.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "engaged": true }, "mythcraft-hud": { "engaged": true } }
  },
  {
    id: 'enthralled',
    label: 'Enthralled',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/enthralled.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/enthralled.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "enthralled": true }, "mythcraft-hud": { "enthralled": true } }
  },
  {
    id: 'fatigued',
    label: 'Fatigued',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/fatigued.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/fatigued.svg',
    ...
    flags: { "mythcraft-essence-sheet": { "fatigued": true }, "mythcraft-hud": { "fatigued": true } }
  },
  {
    id: 'flanking',
    label: 'Flanking',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/flanking.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/flanking.svg',
    ...
    flags: { "mythcraft-essence-sheet": { "flanking": true }, "mythcraft-hud": { "flanking": true } }
  },
  {
    id: 'focused',
    label: 'Focused',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/focused.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/focused.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "focused": true }, "mythcraft-hud": { "focused": true } }
  },
  {
    id: 'frightened',
    label: 'Frightened',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/frightened.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/frightened.svg',
    ...
    flags: { "mythcraft-essence-sheet": { "frightened": true }, "mythcraft-hud": { "frightened": true } }
  },
  {
    id: 'grappled',
    label: 'Grappled',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/grappled.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/grappled.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "grappled": true }, "mythcraft-hud": { "grappled": true } }
  },
  {
    id: 'grounded',
    label: 'Grounded',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/grounded.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/grounded.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "grounded": true }, "mythcraft-hud": { "grounded": true } }
  },
  {
    id: 'helpless',
    label: 'Helpless',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/helpless.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/helpless.svg',
    description: 'When you take melee damage, you lose all of your HP.',
    changes: [],
    flags: { "mythcraft-essence-sheet": { "helpless": true }, "mythcraft-hud": { "helpless": true } }
  },
  {
    id: 'paralyzed',
    label: 'Paralyzed',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/paralyzed.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/paralyzed.svg',
    ...
    flags: { "mythcraft-essence-sheet": { "paralyzed": true, "helpless": true }, "mythcraft-hud": { "paralyzed": true, "helpless": true } }
  },
  {
    id: 'petrified',
    label: 'Petrified',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/petrified.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/petrified.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "petrified": true, "paralyzed": true }, "mythcraft-hud": { "petrified": true, "paralyzed": true } }
  },
  {
    id: 'phobic',
    label: 'Phobic',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/phobic.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/phobic.svg',
    description: 'You are Frightened when you can see the subject of your phobia. This effect is permanent until removed.',
    changes: [],
    flags: { "mythcraft-essence-sheet": { "phobic": true, "frightened": true }, "mythcraft-hud": { "phobic": true, "frightened": true } }
  },
  {
    id: 'pinned',
    label: 'Pinned',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/pinned.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/pinned.svg',
    ...
    flags: { "mythcraft-essence-sheet": { "pinned": true, "prone": true, "grappled": true }, "mythcraft-hud": { "pinned": true, "prone": true, "grappled": true } }
  },
  {
    id: 'prone',
    label: 'Prone',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/prone.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/prone.svg',
    ...
    flags: { "mythcraft-essence-sheet": { "prone": true }, "mythcraft-hud": { "prone": true } }
  },
  {
    id: 'protected',
    label: 'Protected',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/protected.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/protected.svg',
    ...
    flags: { "mythcraft-essence-sheet": { "protected": true }, "mythcraft-hud": { "protected": true } }
  },
  {
    id: 'rallied',
    label: 'Rallied',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/rallied.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/rallied.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "rallied": true }, "mythcraft-hud": { "rallied": true } }
  },
  {
    id: 'restrained',
    label: 'Restrained',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/restrained.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/restrained.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "restrained": true, "grappled": true }, "mythcraft-hud": { "restrained": true, "grappled": true } }
  },
  {
    id: 'shaken',
    label: 'Shaken',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/shaken.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/shaken.svg',
    description: 'You suffer a -2 penalty to all d20 rolls.',
    changes: [
      { key: 'system.bonuses.rolls.all', mode: MODE_ADD, value: "-2" }
    ],
    flags: { "mythcraft-essence-sheet": { "shaken": true }, "mythcraft-hud": { "shaken": true } }
  },
  {
    id: 'sickened',
    label: 'Sickened',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/sickened.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/sickened.svg',
    description: 'Whenever rolling a d20, roll 2d20 and take the lower result.',
    changes: [],
    flags: { "mythcraft-essence-sheet": { "sickened": true }, "mythcraft-hud": { "sickened": true } }
  },
  {
    id: 'silenced',
    label: 'Silenced',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/silenced.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/silenced.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "silenced": true }, "mythcraft-hud": { "silenced": true } }
  },
  {
    id: 'slowed',
    label: 'Slowed',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/slowed.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/slowed.svg',
    description: 'Your speed is halved.',
    changes: [
      { key: 'system.movement.walk', mode: MODE_MULTIPLY, value: "0.5" }
    ],
    flags: { "mythcraft-essence-sheet": { "slowed": true }, "mythcraft-hud": { "slowed": true } }
  },
  {
    id: 'staggered',
    label: 'Staggered',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/staggered.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/staggered.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "staggered": true }, "mythcraft-hud": { "staggered": true } }
  },
  {
    id: 'stunned',
    label: 'Stunned',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/stunned.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/stunned.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "stunned": true }, "mythcraft-hud": { "stunned": true } }
  },
  {
    id: 'suffocating',
    label: 'Suffocating',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/suffocating.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/suffocating.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "suffocating": true }, "mythcraft-hud": { "suffocating": true } }
  },
  {
    id: 'suppressed',
    label: 'Suppressed',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/suppressed.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/suppressed.svg',
    description: 'You cannot use your AP to move. A creature that uses creature actions cannot use them to move.',
    changes: [],
    flags: { "mythcraft-essence-sheet": { "suppressed": true }, "mythcraft-hud": { "suppressed": true } }
  },
  {
    id: 'completeSurprise',
    label: 'Surprised (Complete)',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/surprised(complete).svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/surprised(complete).svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "completeSurprise": true, "surprised": true }, "mythcraft-hud": { "completeSurprise": true, "surprised": true } }
  },
  {
    id: 'partialSurprise',
    label: 'Surprised (Partial)',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/surprised(partial).svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/surprised(partial).svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "partialSurprise": true, "surprised": true }, "mythcraft-hud": { "partialSurprise": true, "surprised": true } }
  },
  {
  ...
  },
  {
    id: 'taunted',
    label: 'Taunted',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/taunted.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/taunted.svg',
    description: 'You have +1 TA attacking the creature that Taunted you, and suffer 1 TD attacking other creatures.',
    changes: [],
    flags: { "mythcraft-essence-sheet": { "taunted": true }, "mythcraft-hud": { "taunted": true } }
  },
  {
    id: 'unconscious',
    label: 'Unconscious',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/unconscious.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/unconscious.svg',
    ...
    changes: [],
    flags: { "mythcraft-essence-sheet": { "unconscious": true }, "mythcraft-hud": { "unconscious": true } }
  },
  {
    id: 'unseen',
    label: 'Unseen',
    img: 'modules/mythcraft-essence-sheet/icons/conditions/unseen.svg',
    icon: 'modules/mythcraft-essence-sheet/icons/conditions/unseen.svg',
